...
var coder = [{
    name: 'merat',
    surname:'sabbagh',
    favoritePerformers:["Ed sheeran","Justin Timberlake " , " Invictus"],
    age: 22,
    myPhoto: "boy1.800x1000.jpg",
    likes:8,
    fun: 'b',
    id:"like"
    },{
    name: 'Maria',
    surname:'Doe',
    favoritePerformers:["Joy" ,"Jean Marie Farina" , "  Femme " ,  ],
    age: 23,
    myPhoto: "girl1.800x1000.jpg",
    likes:4,
    fun: 'b1',
    id:"like1"    
    },{
